...
**display: block; will cause an element to become a block element and have a line break after it.

**display: inline; will cause an element to become inline with other elements and not have a line break.

3. What are the 4 areas of the box model?

**margin, border, padding, container
...
**Git allows a team to collaborate their code safely and provides security by retaining history of submitted code. 
